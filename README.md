...
You can find the deployed project at [https://explorequality.com/](https://explorequality.com/).

## Contributors

|                                        [Juliette Antoniou](https://github.com/julietteantoniou)                                         |                                              [Jordan Doan](https://github.com/jordandoan)                                              |                                    [Nicholas Gonzalez](https://github.com/NickGonzalez04)                                    |                                           [Jonathan Ho](https://github.com/Jonathan-YungHsin-Ho)                                            |                                          [Justin McCutcheon](https://github.com/Jtmccutcheon)                                          |
| :-----------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: |
...
See [Backend Documentation](https://github.com/TheCovey/quality-hub-core-be/blob/master/README.md) for details on the backend of our project.
